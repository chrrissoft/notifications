...
import com.chrrissoft.notifications.expandable.ExpandableState.BuilderState.DecoratedCustomViewStyleState

@Composable
fun Listing(
    data: List<DecoratedCustomViewStyleState>,
...
@Composable
fun Item(
    data: DecoratedCustomViewStyleState,
    onEvent: (ListingEvent) -> Unit,
    modifier: Modifier = Modifier,
) {
    Item(
